          ...
          <div className="flex h-full w-full flex-col items-center justify-center">
            ...
            <div className="mt-12 flex flex-col gap-4">
              ...
              <div className="w-fit items-center">
                <Link href="https://github.com/iamsahilchandel/todo-app" target="_blank" rel="noreferrer">
                  <Button
        ...
        <footer className="bottom-0 container mx-auto my-5 flex flex-col items-center justify-between space-y-3 border-t space-x-4 px-3 pt-4 text-center sm:flex-row sm:pt-2 md:text-lg">
          ...
          <div className="flex space-x-4 pb-4 sm:pb-0">
            <a
              className="group"
              aria-label="Twitter"
              href="https://x.com/iamsahilchandel"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              className="group"
              aria-label="GitHub"
              href="https://github.com/iamsahilchandel/todo-app"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a className="group" aria-label="Youtube" href="#">
              <svg
                viewBox="0 0 256 180"
                width="256"
                height="180"
